...
|Set the (peak) current limit| same as continuous| configPeakCurrentDuration / configContinuousCurrentLimit|New API supports a seperate peak limit current and duration before the continuous limit is enfored.
