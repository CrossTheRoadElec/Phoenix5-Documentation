...
.. warning:: Remote sensors accessed by a Talon FX (Falcon 500) must have a CAN ID of 15 or less.  See errata :ref:`talon-fx-remote-filter-device-id-must-be-15-or-less` for more details.
